...
// Create compound index for intern, date, mentor, and batch to prevent duplicates for same mentor and same batch on the same day
internsAttendanceSchema.index({ intern: 1, date: 1, mentor: 1, batch: 1 }, { unique: true });
